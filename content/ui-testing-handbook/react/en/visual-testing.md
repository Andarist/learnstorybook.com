...
Let's go through each step in detail. Reminder, we’re going to use the Taskbox app as an example.
...
![the task component](/ui-testing-handbook/task.png)
...
We are now ready to write out the test cases.
...
The whole workflow is illustrated below. The handbook goes into more detail about using [Github Actions](https://storybook.js.org/tutorials/visual-testing-handbook/react/en/automate/) to trigger this workflow on each commit.
